  ...
  export default function Products() {
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      if(isLoading) return; //ngăn chặn submission
      setIsLoading(true);
      ...
      } //backend tự giữ lại ảnh cũ nếu không đuọc giữu lại ảnh cũ
      // else if (editingMon) {
          ...
          <div className="form-section">
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-row">
                ...
                <div className="form-group">
                  <label>Giá (VNĐ) *</label>
                  <input type="number" placeholder="25.000" value={monForm.Gia}
